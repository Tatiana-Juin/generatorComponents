...
export const DEFAULT_BLOCKS = {
  card: [
    ...
    { id: 2, type: 'badge', text: 'Nouveau', color: '#a78bfa' },
    { id: 3, type: 'heading', text: 'Titre de la carte', level: 2 },
    { id: 4, type: 'text', text: 'Description courte du contenu de la carte.' },
    { id: 5, type: 'button', text: 'En savoir plus', variant: 'primary' },
  ],
  form: [
    { id: 1, type: 'heading', text: 'Contactez-nous', level: 2 },
